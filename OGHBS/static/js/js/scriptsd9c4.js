...
! function(e, t, n) {
    ...
    function i() {
        ...
        for (var c in s)
            if (s.hasOwnProperty(c)) {
                if (e = [], t = s[c], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))
                    for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
                for (i = o(t.fn, "function") ? t.fn() : t.fn, a = 0; a < e.length; a++) l = e[a], u = l.split("."), 1 === u.length ? Modernizr[u[0]] = i : (!Modernizr[u[0]] || Modernizr[u[0]] instanceof Boolean || (Modernizr[u[0]] = new Boolean(Modernizr[u[0]])), Modernizr[u[0]][u[1]] = i), r.push((i ? "" : "no-") + u.join("-"))
            }
    }
    ...
    Modernizr.inputtypes = function(e) {
        for (var o, i, a, s = e.length, l = "1)", r = 0; s > r; r++) f.setAttribute("type", o = e[r]), a = "text" !== f.type && "style" in f, a && (f.value = l, f.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && f.style.WebkitAppearance !== n ? (u.appendChild(f), i = t.defaultView, a = i.getComputedStyle && "textfield" !== i.getComputedStyle(f, null).WebkitAppearance && 0 !== f.offsetHeight, u.removeChild(f)) : /^(search|tel)$/.test(o) || (a = /^(url|email)$/.test(o) ? f.checkValidity && f.checkValidity() === !1 : f.value != l)), d[e[r]] = !!a;
        return d
    }(p), i(), delete l.addTest, delete l.addAsyncTest;
    for (var m = 0; m < Modernizr._q.length; m++) Modernizr._q[m]();
    e.Modernizr = Modernizr
}(window, document);
var noAnimTimeout, fancyBoxMargin, win = $(window),
    doc = $(document),
    wrap = $('#wrap'),
    body = $('body');
doc.ready(function() {
...
function bookingModal() {
    $('.book-table-btn').on('click', function() {
        $('.booking-widget--modal').addClass('show');
        body.addClass('show-booking-modal raise-booking-modal');
        stopScrolling();
        setTimeout(function() {
            $('.booking-widget--center .booking-widget-inner').prependTo('.booking-widget--modal .booking-widget-wrap');
        }, 500);
        return false;
    });
    $('.close-book-btn').on('click', function() {
        $('.booking-widget--modal').removeClass('show');
        body.removeClass('show-booking-modal');
        setTimeout(function() {
            body.removeClass('raise-booking-modal');
            $('.booking-widget--modal .booking-widget-inner').prependTo('.booking-widget--center .booking-widget-wrap');
        }, 450);
        resumeScrolling();
        return false;
    });
...
function sliders() {
    ...
    if (widgetSlider.find('.slide').length < 2) {
        widgetSlider.find('.text').addClass('single-slide');
    }
    widgetSlider.on("init", function(event, slick) {
        $(".slider-count").text(parseInt(slick.currentSlide + 1) + ' of ' + slick.slideCount);
    });
    createSlider('.widget-slider', false, false, false, false);
    widgetSlider.on("afterChange", function(event, slick, currentSlide) {
        $(".slider-count").text(parseInt(slick.currentSlide + 1) + ' of ' + slick.slideCount);
    });
}
...
function contactFormsAjax() {
    ...
    $('.contact-widget').on('submit', 'form', function(e) {
        e.preventDefault();
        var successMessage = $(this).find('span[data-success]').data('success'),
...
var notificationActive = false,
    notificationTimeout, closeNotificationTimeout, removeNotificationTimeout, notification = $('.notification');
...
function onScroll() {
    $('[data-show]').each(function() {
        var offset, whentoShow = $(this).data("show-percentage");
